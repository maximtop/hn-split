...
The project is in product discovery. Hacker News is the only discussion source in the MVP. Chrome is the first implementation target; Firefox, Edge, and Safari follow after the WebExtension MVP stabilizes.
