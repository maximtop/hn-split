 ...
 */
export const AMO_APPROVAL_NOTES_SUMMARY = 'Finds the Hacker News discussion for the current '
    + 'article and opens it in an adjacent tab or the sidebar. Sends public page and link URLs to '
    + 'the Algolia Hacker News Search API to find the discussion; the sidebar embeds the Hacker '
    + 'News page. No extension account, no remote code.';
